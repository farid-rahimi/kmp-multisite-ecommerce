...
val accountModule = module {
    factory {
        AccountViewModel(
            ...
            signupByUserPassUseCase = get(),
            requestPasswordResetOtpUseCase = get(),
            verifyPasswordResetOtpUseCase = get(),
            resetPasswordByOtpUseCase = get(),
            requestDeleteAccountOtpUseCase = get(),
            deleteAccountWithPasswordUseCase = get(),
            deleteAccountWithOtpUseCase = get(),
            clearLocalUserDataUseCase = get(),
            logoutUseCase = get(),
