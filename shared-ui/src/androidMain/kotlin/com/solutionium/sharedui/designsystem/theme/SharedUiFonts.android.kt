...
actual object SharedUiFonts {
    ...
    private fun persianFontFamily(): FontFamily = FontFamily(
        ...
        Font(Res.font.vazir_bold, FontWeight.ExtraBold),
        Font(Res.font.vazir_black, FontWeight.Black)
    )

    @Composable
    @OptIn(ExperimentalResourceApi::class)
    private fun arabicFontFamily(): FontFamily = FontFamily(
        ...
        Font(Res.font.vazirmatn_bold, FontWeight.ExtraBold),
